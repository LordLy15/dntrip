# Task 7: Budget Status Badge Widget

## Overview
Create the BudgetStatusBadge widget that displays the 5 budget conditions with appropriate colors.
...
- [ ] BudgetStatusBadge widget created
- [ ] All 5 budget statuses handled with correct colors
- [ ] Shows label and amount
- [ ] Matches spec design (colors, icons, labels)

## Notes

- Follows the color scheme from the spec
- On Budget: Green (#E8F5E9 / #2E7D32)
- Underbudget: Blue (#E3F2FD / #1565C0)
- Deficit: Orange (#FFFFF3E0 / #E65100)
- Surplus: Dark Green (#C8E6C9 / #1B5E20)
- Off-Budget: Grey (#EEEEEE / #616161)
