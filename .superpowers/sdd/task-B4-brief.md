...
**Interfaces:**
- Consumes: AuthRepository, HiveStorage, ApiClient
- Produces: AuthNotifier, LoginNotifier, RegisterNotifier

**Note:** Task B3 (Auth Data Layer) must be complete before this task.
...
**Step 2: Verify providers compile**

Run:
```powershell
cd frontend && flutter analyze lib/features/auth/domain/
```

Expected: No errors (warnings about generated files are OK)
